...
namespace BlankApp1
{
    ...
    {
        /// <summary>
        /// Writes text to the debugger console.
        /// </summary>
        /// <param name="text">The text.</param>
        [DebuggerStepThrough]
        public static void ConsoleText(this string text)
        {
            text.ColoredWriteLine();
        }
        ...
        [DebuggerStepThrough]
        public static void ColoredWriteLine(this string text)
        {
